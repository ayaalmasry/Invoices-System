...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">أهلا بعودتك!</h2>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">{{\App\invoices::where('value_status',1)->count()}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">  {{round((\App\invoices::where('value_status',1)->count()/\App\invoices::count())*100)}}%
                                  </span>
										</span>
									</div>
								</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">{{\App\invoices::where('value_status',3)->count()}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">  {{round((\App\invoices::where('value_status',3)->count()/\App\invoices::count())*100)}}%
                                  </span>
										</span>
									</div>
								</div>
