...
@if (session()->has('restore_invoice'))
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th class=" border-bottom-0">رقم الفاتورة</th>
                                                 <th class=" border-bottom-0">تاريخ االفاتورة</th>
										...
										<tbody>
											...
											<tr>
												...
												<td>{{$x->Due_date}}</td>
												<td>{{$x->product}}</td>
                                                <td><a href="{{url('InvoicesDetails')}}/{{$x->id}}">{{$x->section->section_name}}</a></td>
                                                <td>{{$x->Value_VAT}}</td>
                                                <td>{{$x->Rate_VAT}}</td>
                                                <td>{{$x->Total}}</td>
                                                <td>{{$x->Discount}}</td>
	...
	<div  class="dropdown-menu tx-13">
        ...
        <a class="dropdown-item"
                                                            href=" {{ url('Status_Show') }}/{{ $x->id }}"><i class=" text-success fas fa-money-bill"></i>
                                                            تغير حالة الدفع</a>
        @endcan
         @can('ارشفة الفاتورة')
        <a class="dropdown-item" href="#" data-invoice_id="{{ $x->id }}"
